...
def setup_cur(session, account_id, bucket_region='us-west-2'):
    ...
    try:
        ...
        print(f'✓ Successfully configured bucket policy')
    except Exception as e:
    ...
    try:
        ...
        print(f'  - Includes resource IDs: Yes')
...
Examples:
  ...
  python setup_cur.py
    ...
    parser.add_argument('--account-id', help='AWS account ID (optional, will be auto-detected)')
